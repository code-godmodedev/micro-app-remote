...
const quote_1 = __nccwpck_require__(309);
const object_1 = __nccwpck_require__(306);
const function_1 = __nccwpck_require__(869);
/**
...
const createMap = __nccwpck_require__(954);
const createChainable = __nccwpck_require__(178);
...
const createSet = __nccwpck_require__(455);
const createChainable = __nccwpck_require__(178);
...
const Callable = __nccwpck_require__(794);
const createMap = __nccwpck_require__(954);
const createChainable = __nccwpck_require__(178);
const createValue = __nccwpck_require__(863);
...
const ChainedMap = __nccwpck_require__(855);
const ChainedValueMap = __nccwpck_require__(157);
const ChainedSet = __nccwpck_require__(956);
const Resolve = __nccwpck_require__(381);
const ResolveLoader = __nccwpck_require__(52);
const Output = __nccwpck_require__(492);
const DevServer = __nccwpck_require__(207);
const Plugin = __nccwpck_require__(292);
const Module = __nccwpck_require__(441);
const Optimization = __nccwpck_require__(166);
const Performance = __nccwpck_require__(885);
...
const ChainedMap = __nccwpck_require__(855);
const Rule = __nccwpck_require__(374);
...
const ChainedMap = __nccwpck_require__(855);
const Orderable = __nccwpck_require__(336);
  ...
  class extends ChainedMap {
    ...
    toConfig() {
      ...
      if (typeof plugin === 'string') {
        pluginPath = plugin;
        plugin = __nccwpck_require__(445)(pluginPath);
      }
...
const ChainedSet = __nccwpck_require__(956);
const Orderable = __nccwpck_require__(336);
const Use = __nccwpck_require__(749);
const Resolve = __nccwpck_require__(381);
